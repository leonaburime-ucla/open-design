/** @module core/ensure-core-stages
 * Plugin foundation kernel: shared registry, snapshot, event, trust, connector, and pipeline primitives with no sibling dependencies.
 */

 ...
 * Plugin runtime concern: applies manifests, resolves snapshots, runs pipelines, simulates, verifies, exports, and cleans snapshots.
 */
...
import { resolveCapabilitiesGranted, requiredCapabilities } from '../core/index.js';
import {
...
import { deriveAutoAtomSurfaces } from '../atoms/index.js';
import { ensureCoreQualityStages } from '../core/index.js';
import { getManifestContextCraft } from '../core/index.js';

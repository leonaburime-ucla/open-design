/** @module install/skill-candidates
 * Plugin install concern: installs, packages, publishes, scaffolds, and promotes plugin packages and candidates.
 */
...
import { validatePluginFolder, flattenValidationDiagnostics } from '../catalog/index.js';

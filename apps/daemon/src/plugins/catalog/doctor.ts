/** @module catalog/doctor
 * Plugin catalog concern: reads, validates, diagnoses, searches, and summarizes installed plugins and marketplaces.
 */
...
import { findAtom, isImplementedAtom, isKnownAtom } from '../atoms/index.js';
import { validateConnectorRefs, type ConnectorProbe } from '../core/index.js';
import { isParseableUntil } from '../core/index.js';
import { listSnapshotsForProject, markSnapshotStale } from '../core/index.js';

/** @module catalog/registry-view
 * Builds the live plugin registry view used by plugin/apply routes: skills,
 * design systems, first-party atoms, and bundled scenario fallbacks.
 * Catalog may depend on atoms through the atom barrel and shared registry
 * reads through the core barrel.
 */
// @ts-nocheck — carried over verbatim from server.ts's file-level @ts-nocheck.

import { FIRST_PARTY_ATOMS } from '../atoms/index.js';
import { listInstalledPlugins } from '../core/index.js';

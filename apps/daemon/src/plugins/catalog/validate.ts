...
import { doctorPlugin, type DoctorReport, type Diagnostic } from '../catalog/index.js';
import { resolvePluginFolder } from '../core/index.js';
import type { ConnectorProbe } from '../core/index.js';

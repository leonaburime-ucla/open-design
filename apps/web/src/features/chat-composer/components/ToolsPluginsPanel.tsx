// Dumb plugin picker for the composer tools flyout: Official / My plugins
// segments + search, applying or opening details for a plugin. Local search and
// pending-apply state only; the plugin list and apply transport come as props.

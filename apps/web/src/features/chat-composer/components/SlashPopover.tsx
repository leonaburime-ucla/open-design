// Dumb `/`-command popover: a keyboard-navigable list of slash commands.
// Presentational — the active index and pick/hover handling live in the
// orchestrator's composer input.

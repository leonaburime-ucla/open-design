// Dumb @-mention popover: tabbed, keyboard-navigable list of files, workspace
// tabs, plugins, skills, MCP servers, and connectors. Presentational — the query,
// active tab/index, and pick handling live in the orchestrator's composer input.

// Dumb MCP picker for the composer tools flyout: search over configured servers
// and templates, insert a server hint, or jump to Settings to manage. Local
// search state only; the server/template lists come as props.

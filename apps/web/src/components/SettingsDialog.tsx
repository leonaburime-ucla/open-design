...
// Backward-compatible re-export: the definitions and the ConnectorSection
// component now live in the settings slice. Kept as a thin pass-through so this
// orchestrator's public export surface stays identical (external importers and
// existing tests are unaffected); production consumers import the slice barrel
// directly.
export {
  ConnectorSection,
...
export type { ComposioCredentialState } from '../features/settings';
import {
  MAX_MAX_TOKENS,
  MIN_MAX_TOKENS,

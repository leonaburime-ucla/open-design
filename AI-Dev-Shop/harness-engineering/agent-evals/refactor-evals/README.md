...
Canonical seed design for the Refactor agent eval suite.
...
- Canonical design doc: `refactor-eval-design.md`
...
Generate the benchmark suite files from `refactor-eval-design.md`, then validate the generated suite with `validate_eval_suite.py`.

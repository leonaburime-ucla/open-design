...
Canonical seed design and initial benchmark suite for the TDD agent.
...
- Canonical design doc: `tdd-eval-design.md`
...
- Suite path: `harness-engineering/agent-evals/tdd-evals/benchmark-suite`
- Seed count: 27
- Dimensions: 3
